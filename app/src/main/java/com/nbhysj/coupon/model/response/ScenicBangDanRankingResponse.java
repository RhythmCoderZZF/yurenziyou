 ...
 * description：
 */
public class ScenicBangDanRankingResponse {

    private List<ScenicSpotBean> mchs;

    private BannerEntity banner;

    public List<ScenicSpotBean> getMchs() {
        return mchs;
    }

    public void setMchs(List<ScenicSpotBean> mchs) {
        this.mchs = mchs;
    }
