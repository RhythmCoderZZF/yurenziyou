...
public class GroupMchTabIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public GroupMchTabIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GroupMchTabIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void initTab(List<GroupMchResponse.TagsEntity> labelList, int textSize) {
