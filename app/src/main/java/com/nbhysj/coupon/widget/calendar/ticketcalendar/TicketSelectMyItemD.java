...
public class TicketSelectMyItemD extends RecyclerView.ItemDecoration {
    Paint paint = new Paint();
    Paint colorPaint = new Paint();
    Paint linePaint = new Paint();

    public TicketSelectMyItemD() {
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
      ...
      try {
        ...
        //获取第一个可见的view，通过此view获取其对应的月份
          TicketSelectCalendarList.CalendarAdapter a = (TicketSelectCalendarList.CalendarAdapter) parent.getAdapter();
