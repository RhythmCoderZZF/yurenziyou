package com.nbhysj.coupon.widget.dropdownmenu;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        params.setMargins(dpTpPx(2), 0, 0, 0);
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        layoutParams.setMargins(dpTpPx(8), 0, dpTpPx(8), 0);
        ...
        if (i == tabTexts.size() - 1) {
            tab.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.mipmap.icon_well_known_literatus), null, null, null);
        } else {
        ...
        tab.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = tabMenuView.getChildAt(tabMenuView.getChildCount() - 1);
              /*  if(tab == view){
        ...
        if (i < tabTexts.size() - 1) {
            ...
            LayoutParams layoutParams1 = new LayoutParams(dpTpPx(0.5f), dpTpPx(12));
            layoutParams1.setMargins(0, dpTpPx(5), 0, 0);
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                   ...
                   /* if(target == tabMenuView.getChildAt(tabMenuView.getChildCount() - 1)){
                        ((TextView) tabMenuView.getChildAt(tabMenuView.getChildCount() - 1)).setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.mipmap.icon_hotel), null, null, null);
                    } else {
...
*/
                //  ((TextView) tabMenuView.getChildAt(tabMenuView.getChildCount() - 1)).setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.mipmap.icon_hotel), null, null, null);
                if (i != tabMenuView.getChildCount() - 1) {
                    ((TextView) tabMenuView.getChildAt(i)).setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(menuUnselectedIcon), null);
                }
    ...
    public void getScreenParams(Context context) {
        ...
        mScreenHight = mDisplayMetrics.heightPixels;
    }
}
