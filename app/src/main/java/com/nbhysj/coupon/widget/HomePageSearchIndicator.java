...
/**
 * @auther：hysj created on 2019/03/31
 * description：首页搜索指示器
 */

@SuppressLint("NewApi")
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class HomePageSearchIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public HomePageSearchIndicator(Context context) {
        super(context);
        init(context);
    }

    public HomePageSearchIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public HomePageSearchIndicator(Context context, AttributeSet attrs, int defStyle) {
