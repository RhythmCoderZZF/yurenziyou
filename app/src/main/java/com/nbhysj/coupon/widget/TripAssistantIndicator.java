...
public class TripAssistantIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public TripAssistantIndicator(Context context) {
        super(context);
        init(context);
    }

    public TripAssistantIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TripAssistantIndicator(Context context, AttributeSet attrs, int defStyle) {
