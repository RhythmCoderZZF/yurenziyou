...
/**
 * @auther：hysj created on 2019/03/07
 * description：星级评价
 */
public class OrderCommentStarBarView extends View {
    ...
    public OrderCommentStarBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public OrderCommentStarBarView(Context context, AttributeSet attrs, int defStyleAttr) {
