 ...
 */
public class ScenicSpotDetailBannerView extends FrameLayout {
    ...
    public ScenicSpotDetailBannerView(Context context) {
        super(context);
        this.init();
    }

    public ScenicSpotDetailBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }
    ...
    public void startLoop(boolean flag) {
        if (flag) {
            if (this.mBannerHandler == null) {
                this.mBannerHandler = new ScenicSpotDetailBannerView.BannerHandler(this);
            }
        ...
        if (viewList != null && viewList.size() != 0) {
            ...
            ScenicSpotDetailBannerAdapter bannerAdapter = new ScenicSpotDetailBannerAdapter(mContext, viewList, bannerUrlList, new ScenicSpotDetailBannerAdapter.ScenicSpotDetailBannerListener() {
                ...
                public void scenicSpotDetailBannerListener() {
                    ...
                    scenicSpotDetailBannerViewListener.bannerOnclickListener();
                }
            });
    ...
    private static class BannerHandler extends Handler {
        private WeakReference<ScenicSpotDetailBannerView> weakReference = null;

        public BannerHandler(ScenicSpotDetailBannerView bannerView) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (this.weakReference != null) {
                ScenicSpotDetailBannerView bannerView = (ScenicSpotDetailBannerView) this.weakReference.get();
                if (bannerView != null && bannerView.mViewPager != null && bannerView.mViewPager.getAdapter() != null && bannerView.mViewPager.getAdapter().getCount() > 0) {
                    ...
                    this.sendEmptyMessageDelayed(1000, ScenicSpotDetailBannerView.LOOP_INTERVAL);
                } else {
                    this.sendEmptyMessageDelayed(1000, ScenicSpotDetailBannerView.LOOP_INTERVAL);
                }
            }
