...
public class BezierDemoView extends View {
    ...
    /*    float x = getWidth() / 8;
       ...
       // canvas.drawArc(oval,-90,120,false,mPaint);
        ...
        startPoint = new Point(0, 100);//设置起点（可以自定义）
        ...
        int colorStart = getResources().getColor(R.color.color_green2);
        int colorEnd = getResources().getColor(R.color.color_line_view);
