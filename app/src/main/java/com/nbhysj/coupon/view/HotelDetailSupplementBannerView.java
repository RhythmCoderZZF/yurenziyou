...
import com.nbhysj.coupon.adapter.HotelDetailSupplementBannerAdapter;
 ...
 * description：景点详情banner 控件
 */
public class HotelDetailSupplementBannerView extends FrameLayout {
    ...
    private HotelDetailSupplementBannerView.BannerHandler mBannerHandler = null;
    ...
    public HotelDetailSupplementBannerView(Context context) {
        super(context);
        this.init();
    }

    public HotelDetailSupplementBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }
    ...
    public void startLoop(boolean flag) {
        if (flag) {
            if (this.mBannerHandler == null) {
                this.mBannerHandler = new HotelDetailSupplementBannerView.BannerHandler(this);
            }
    ...
    public void setViewList(Context mContext, List<ImageView> viewList, List<String> bannerUrlList, ScenicSpotDetailBannerViewListener scenicSpotDetailBannerViewListener) {
        ...
        if (viewList != null && viewList.size() != 0) {
            ...
            HotelDetailSupplementBannerAdapter bannerAdapter = new HotelDetailSupplementBannerAdapter(mContext, viewList, bannerUrlList);
    ...
    private static class BannerHandler extends Handler {
        private WeakReference<HotelDetailSupplementBannerView> weakReference = null;

        public BannerHandler(HotelDetailSupplementBannerView bannerView) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (this.weakReference != null) {
                HotelDetailSupplementBannerView bannerView = (HotelDetailSupplementBannerView) this.weakReference.get();
                if (bannerView != null && bannerView.mViewPager != null && bannerView.mViewPager.getAdapter() != null && bannerView.mViewPager.getAdapter().getCount() > 0) {
                    ...
                    this.sendEmptyMessageDelayed(1000, HotelDetailSupplementBannerView.LOOP_INTERVAL);
                } else {
                    this.sendEmptyMessageDelayed(1000, HotelDetailSupplementBannerView.LOOP_INTERVAL);
                }
            }
