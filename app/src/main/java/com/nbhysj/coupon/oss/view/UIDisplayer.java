package com.nbhysj.coupon.oss.view;
...
public class UIDisplayer {
    ...
    private UIDisPlayerListener uiDisPlayerListener;

    /* 必须在UI线程中初始化handler */
    public UIDisplayer(Activity activity, UIDisPlayerListener uiDisPlayerListener) {

        //this.bar = bar;
        // this.infoView = infoView;
        this.activity = activity;
        this.uiDisPlayerListener = uiDisPlayerListener;
            ...
            public void handleMessage(Message inputMessage) {
                ...
                switch (inputMessage.what) {
                    ...
                    case UPLOAD_OK:
                        ...
                        uiDisPlayerListener.setUIDisPlayerListener();
                        break;
                    case UPLOAD_FAIL:
    ...
    //上传成功
    public void uploadComplete(int imageWidth, int imageHight) {
    ...
    public interface UIDisPlayerListener {

        void setUIDisPlayerListener();
    }
}
