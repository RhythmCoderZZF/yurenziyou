...
public class FileUtils {
    ...
    public static List<File> getWavFiles(Context context) {
     ...
     /*   try {
            ...
            mmr.setDataSource(context, Uri.fromFile(new File(fileBasePath + "/20190325090209.wav")));
            String time = mmr.extractMetadata(MediaMetadataRetriever.METADATA_KEY_DURATION);
            System.out.print(time);


            MediaPlayer mediaPlayer = new MediaPlayer();
            mediaPlayer.setDataSource(context, Uri.fromFile(new File(fileBasePath+ "/20190325090209.wav")));
            mediaPlayer.prepare();
