 ...
 * description:问答详情(回答)适配器
 */
public class QuestionAndAnswerDetailsAnswerAdapter extends RecyclerView.Adapter<QuestionAndAnswerDetailsAnswerAdapter.ViewHolder> {
    ...
    public QuestionAndAnswerDetailsAnswerAdapter(Context mContext, QuestionAndAnswerDetailsAnswerListener questionAndAnswerDetailsAnswerListener) {
