...
/**
 * @author hysj created on 2019/12/09.
 * description:  其他用户页面收藏(全部)适配器
 */
public class OthersCollectionAllItemAdapter extends RecyclerView.Adapter<OthersCollectionAllItemAdapter.ViewHolder> {
    ...
    public OthersCollectionAllItemAdapter(Context mContext) {
            ...
            if(photosUrl != null) {
                ...
                MineCollectionAllSubItemAdapter mineCollectionAllSubItemAdapter = new MineCollectionAllSubItemAdapter(mContext, new MineCollectionAllSubItemAdapter.MineCollectionAllItemListener() {
                    ...
                    public void setMineCollectionAllItemListener(int position) {
                        ...
                        intent.setClass(mContext, OthersCollectionDetailsActivity.class);
