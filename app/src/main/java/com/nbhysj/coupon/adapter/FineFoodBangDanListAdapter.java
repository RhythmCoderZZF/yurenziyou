 ...
 * description : 美食(榜单）列表适配器
 */
public class FineFoodBangDanListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//        notifyItemChanged(1,1);
    ...
    public FineFoodBangDanListAdapter(Context mContext) {
