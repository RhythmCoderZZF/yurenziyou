...
/**
 * @author hysj created at 2019/06/07.
 * description:互动列表适配器
 */
public class InteractionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<PopularScenicSpotsResponse> popularScenicSpotsList;
    private Context mContext;
    LayoutInflater mInflater;

    public InteractionListAdapter(Context mContext) {
