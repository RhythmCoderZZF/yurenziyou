 ...
 * description : 酒店名宿适配器
 */
public class HousingRulesAdapter extends RecyclerView.Adapter<HousingRulesAdapter.ViewHolder> {

    List<MchTypeBean> hotelReputationList;
    private Context mContext;
    private HomestayCollectionListener homestayCollectionListener;

    public HousingRulesAdapter(Context mContext, HomestayCollectionListener homestayCollectionListener) {

        this.mContext = mContext;
        this.homestayCollectionListener = homestayCollectionListener;
    }

    public void setHousingRulesList(List<MchTypeBean> hotelReputationList) {
