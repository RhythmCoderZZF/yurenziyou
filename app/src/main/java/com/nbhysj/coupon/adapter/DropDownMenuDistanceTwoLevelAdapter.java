 ...
 */
public class DropDownMenuDistanceTwoLevelAdapter extends RecyclerView.Adapter<DropDownMenuDistanceTwoLevelAdapter.ViewHolder> {
    private DropDownMenuListener dropDownMenuListener;
    List<PositionDistanceSearchBean> positionDistanceTypeClassifyList;
    private Context mContext;

    public DropDownMenuDistanceTwoLevelAdapter(Context mContext, DropDownMenuListener dropDownMenuListener) {
