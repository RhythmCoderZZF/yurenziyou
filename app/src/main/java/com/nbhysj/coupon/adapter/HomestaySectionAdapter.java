 ...
 * description : 民宿页面栏目适配器
 */
public class HomestaySectionAdapter extends RecyclerView.Adapter<HomestaySectionAdapter.ViewHolder> {

    List<MchTypeBean> hotelHomestayList;
    private Context mContext;

    public HomestaySectionAdapter(Context mContext) {
