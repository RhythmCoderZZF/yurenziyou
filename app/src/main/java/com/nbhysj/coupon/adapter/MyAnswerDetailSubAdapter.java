 ...
 */
public class MyAnswerDetailSubAdapter extends RecyclerView.Adapter<MyAnswerDetailSubAdapter.ViewHolder> {

    private List<AnswerBean> answerList;
    private Context mContext;
    private AnswerUsefulListener answerUsefulListener;

    public MyAnswerDetailSubAdapter(Context mContext, AnswerUsefulListener answerUsefulListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_my_answer_detail_sub_item, parent, false);//解决宽度不能铺满
