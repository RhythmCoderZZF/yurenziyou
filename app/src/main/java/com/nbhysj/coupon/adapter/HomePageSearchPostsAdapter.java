 ...
 */
public class HomePageSearchPostsAdapter extends RecyclerView.Adapter<HomePageSearchPostsAdapter.ViewHolder> {
    ...
    public HomePageSearchPostsAdapter(Context mContext, RecommendPostsDetailListener recommendPostsDetailListener) {

        this.mContext = mContext;
        this.recommendPostsDetailListener = recommendPostsDetailListener;
    }

    public void setRecommendFriendsPictureList(List<HomeSearchMchTypeBean> recommendFriendsPictureList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int itemPosition) {
        ...
        try {
            ...
            HomeSearchMchTypeBean recommendFriends = mRecommendFriendsList.get(itemPosition);
         ...
         //   GlideUtil.loadImage(mContext, avatar, holder.mImageAvatar);
            ...
            int postsType = Integer.parseInt(recommendFriends.getPostsType()); //1图片，2语音，3视频
