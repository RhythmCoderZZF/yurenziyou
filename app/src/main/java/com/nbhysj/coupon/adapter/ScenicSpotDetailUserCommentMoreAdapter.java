 ...
 * description:景点详情查看用户全部评论适配器
 */
public class ScenicSpotDetailUserCommentMoreAdapter extends RecyclerView.Adapter<ScenicSpotDetailUserCommentMoreAdapter.ViewHolder> {
    ...
    public ScenicSpotDetailUserCommentMoreAdapter(Context mContext) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.mStarBarScenicSpots.setStarMark(userCommentResponse.getStarLevel());
