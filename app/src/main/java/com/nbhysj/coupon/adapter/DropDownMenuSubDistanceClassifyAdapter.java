 ...
 */
public class DropDownMenuSubDistanceClassifyAdapter extends RecyclerView.Adapter<DropDownMenuSubDistanceClassifyAdapter.ViewHolder> {
    private DropDownMenuListener dropDownMenuListener;
    List<PositionDistanceBean.PositionDistanceTypeClassifyTwoLevel> positionDistanceTypeClassifyList;
    private Context mContext;

    public DropDownMenuSubDistanceClassifyAdapter(Context mContext, DropDownMenuListener dropDownMenuListener) {

        this.mContext = mContext;
        this.dropDownMenuListener = dropDownMenuListener;
    }

    public void setPositionDistanceList(List<PositionDistanceBean.PositionDistanceTypeClassifyTwoLevel> positionDistanceTypeClassifyList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int itemPosition) {
        ...
        try {
            ...
            PositionDistanceBean.PositionDistanceTypeClassifyTwoLevel positionDistanceBean = positionDistanceTypeClassifyList.get(itemPosition);
            String sortCondition = positionDistanceBean.getTwoLevelName();
    ...
    public interface DropDownMenuListener {
        ...
        void setDropDownMenuListener(int position, PositionDistanceBean.PositionDistanceTypeClassifyTwoLevel positionDistanceBean);
    }
