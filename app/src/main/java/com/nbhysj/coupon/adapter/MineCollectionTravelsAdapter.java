 ...
 * description : 我的页面收藏(游记)适配器
 */
public class MineCollectionTravelsAdapter extends RecyclerView.Adapter<MineCollectionTravelsAdapter.ViewHolder> {

    List<MineCollectionAlbumResponse> collectionAlbumResponseList;
    private Context mContext;


    public MineCollectionTravelsAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_mine_collection_travels_item, parent, false);//解决宽度不能铺满
    ...
    public void onBindViewHolder(ViewHolder holder, final int itemPosition) {
        ...
        try {
            ...
            GlideUtil.loadCornersTransformImage(mContext, "https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3088831652,3571247956&fm=26&gp=0.jpg", 5, holder.mImageScenicSpots);
