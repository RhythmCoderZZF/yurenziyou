 ...
 * description : 商户领券适配器
 */
public class ReceiveCouponTypeListAdapter extends RecyclerView.Adapter<ReceiveCouponTypeListAdapter.ViewHolder> {

    List<CouponsBean> couponList;
    private Context mContext;
    private CouponToUseListener couponToUseListener;

    public ReceiveCouponTypeListAdapter(Context mContext, CouponToUseListener couponToUseListener) {
   ...
   public void setCouponList(List<CouponsBean> couponList) {
        ...
        try {
            ...
            holder.mTvCouponToUse.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    couponToUseListener.setCouponToUseCallback(itemPosition);
    ...
    public interface CouponToUseListener{
        ...
        void setCouponToUseCallback(int position);
