...
//        notifyItemChanged(1,1);
    ...
    public RecreationBangDanListAdapter(Context mContext) {

        this.mContext = mContext;
    }

    public void setPopularScenicSpotsList(List<MchTypeBean> recreationList) {
    ...
    public int getItemCount() {
        return mHeaderView != null ? recreationList.size() + 1: recreationList.size();
    }
