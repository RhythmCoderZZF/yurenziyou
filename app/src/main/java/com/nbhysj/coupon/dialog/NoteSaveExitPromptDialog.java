 ...
 * description：发布帖子退出提示
 */
public class NoteSaveExitPromptDialog {
    ...
    public NoteSaveExitPromptDialog(Context context) {
    ...
    public NoteSaveExitPromptDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.layout_note_save_exit_prompt, null);
    ...
    public NoteSaveExitPromptDialog setTitle(String title) {
        showTitle = true;
    ...
    public NoteSaveExitPromptDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public NoteSaveExitPromptDialog setCanceledOnTouchOutside(boolean cancel) {
    ...
    public void setSheetItems()
    {
        ...
        int size = sheetItemList.size();
           ...
           /* if (color == null) {
                ...
                //textView.setText(RadiusGradientSpanUtil.getRadiusGradientSpan("立即绑定",0xFF1DEB96, 0xFF0DDDF6));

                if (i == 1) {
                    textView.setText(RadiusGradientSpanUtil.getRadiusGradientSpan("保存草稿", 0xFF0DDDF6, 0xFF1DEB96));
                } else {
                    int mColor = Color.parseColor("#FE2C4A");
                    textView.setTextColor(mColor);
                }
            }
*/
