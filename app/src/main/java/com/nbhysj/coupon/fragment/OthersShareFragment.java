...
public class OthersShareFragment extends BaseFragment<OthersHomePagePresenter, OthersHomePageModel> implements OthersHomePageContract.View {
    ...
    public static OthersShareFragment newInstance(int userId) {
        OthersShareFragment fragment = new OthersShareFragment();
        ...
        shareAdapter = new ShareAdapter(getActivity(), new ShareAdapter.ShareListener() {
            ...
            public void setShareListener(int mPostId,int groupPosition,int childPosition) {
                ...
                if (othersPostOprateDialog == null) {
                    othersPostOprateDialog = new OthersPostOprateDialog(getActivity(), new OthersPostOprateDialog.OnSharePlatformItemClickListener() {
                        @Override
    ...
    public void getOthersPostShareList() {
        ...
        if (validateInternet()) {
            ...
            mPresenter.getOthersPostShareList(userId);
        }
    }
