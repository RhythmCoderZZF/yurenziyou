 ...
 * description：景点首页搜索互动
 */
public class HomeSearchRecreationFragment extends BaseFragment<HomePagePresenter, HomePageModel> implements HomePageContract.View {
    ...
    //商品(景点)类型
    private String mchType = HomeSearchMchTypeEnum.MCH_RECREATION.getValue();
    //关键字
    private String keyWord = HomeSearchMchTypeEnum.ALL.getValue();

    private HomePageSearchRecreationAdapter homePageSearchRecreationAdapter;

    private boolean visibleToUser;
    public HomeSearchRecreationFragment() {
        // Required empty public constructor
    }

    public static HomeSearchRecreationFragment newInstance(String param1, String param2) {
        HomeSearchRecreationFragment fragment = new HomeSearchRecreationFragment();
    ...
    public void initView(View v) {
        ...
        homePageSearchRecreationAdapter = new HomePageSearchRecreationAdapter(getActivity());
        homePageSearchRecreationAdapter.setRecreationList(homeSearchMchTypeList);
        mRvMchTypeList.setAdapter(homePageSearchRecreationAdapter);
    }
            ...
            public void onRefresh(final RefreshLayout refreshLayout) {
                refreshLayout.getLayout().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mPageNo = 1;
                        homeSearchMchTypeList.clear();
                        homePageSearchRecreationAdapter.notifyDataSetChanged();
