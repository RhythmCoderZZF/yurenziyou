...
public class HomestayCommentFragment extends BaseFragment<HomestayPresenter, HomestayModel> implements HomestayContract.View {
    ...
    public HomestayCommentFragment() {
        // Required empty public constructor
    }

    public static HomestayCommentFragment newInstance(int landlordId) {
        HomestayCommentFragment fragment = new HomestayCommentFragment();
    ...
    public int getLayoutId() {
        return R.layout.fragment_landlord_homestay_comment;
    }
