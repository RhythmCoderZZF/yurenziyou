...
public class TravelAssisantAddScenicSpotFragment extends BaseFragment<TravelAssistantPresenter, TravelAssistantModel> implements TravelAssistantContract.View {
    ...
    public TravelAssisantAddScenicSpotFragment() {
        // Required empty public constructor
    }

    public static TravelAssisantAddScenicSpotFragment newInstance(int mTripId, String mCountyId, int dayIndex) {
        TravelAssisantAddScenicSpotFragment fragment = new TravelAssisantAddScenicSpotFragment();
    ...
    public void addScenicSpotRequest(int mchId) {
        ...
        if (validateInternet()) {
            ...
            String mchType = MchTypeEnum.getEnumByKey(0);
