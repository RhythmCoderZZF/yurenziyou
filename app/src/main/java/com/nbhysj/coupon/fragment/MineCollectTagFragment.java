...
public class MineCollectTagFragment extends BaseFragment {
    ...
    public MineCollectTagFragment() {
        // Required empty public constructor
    }

    public static MineCollectTagFragment newInstance(String param1, String param2) {
        MineCollectTagFragment fragment = new MineCollectTagFragment();
    ...
    public void initView(View v) {
        ...
        MineCollectionTagAdapter mineCollectionTagAdapter = new MineCollectionTagAdapter(getActivity());
        mRvMineCollectionTravels.setAdapter(mineCollectionTagAdapter);
