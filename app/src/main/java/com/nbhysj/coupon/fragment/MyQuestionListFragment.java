 ...
 */
public class MyQuestionListFragment extends BaseFragment<MchQuestionAndAnswerPresenter, MchQuestionAndAnswerModel> implements MchQuestionAndAnswerContract.View {
    ...
    public static MyQuestionListFragment newInstance(String orderStatus) {

        MyQuestionListFragment fragment = new MyQuestionListFragment();
    ...
    protected void initView(View v) {
        ...
        myQuestionListAdapter = new MyQuestionListAdapter(getActivity());
        myQuestionListAdapter.setMyQuestionList(myQuestionAnsweringList);
    ...
    public void getMyQuestionList() {
        ...
        if (validateInternet()) {
            ...
            mPresenter.getMyQuestionList(mPageNo, mPageSize);
        }
    }
}
