 ...
 * description：景点榜单列表
 */
public class ScenicSpotBangDanListActivity extends BaseActivity<ScenicSpotPresenter, ScenicSpotModel> implements ScenicSpotContract.View {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        scenicSpotsLinearLayoutManager = new LinearLayoutManager(ScenicSpotBangDanListActivity.this);
        ...
        scenicSpotsListAdapter = new ScenicSpotBangDanListAdapter(ScenicSpotBangDanListActivity.this);
        scenicSpotsListAdapter.setPopularScenicSpotsList(mScenicSpotList);
        mRvScenicSpotBangdan.setAdapter(scenicSpotsListAdapter);
    ...
    public void getScenicBangDanRankingResult(BackResult<MchBangDanRankingResponse> res) {
        ...
        switch (res.getCode()) {
            case Constants.SUCCESS_CODE:
                ...
                break;
            default:
                showToast(ScenicSpotBangDanListActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
    ...
    public void showMsg(String msg) {
        ...
        dismissProgressDialog();
        showToast(ScenicSpotBangDanListActivity.this,Constants.getResultMsg(msg));
    }
    ...
    public void getScenicSpotBangDanList() {
        ...
        if (validateInternet()) {
            ...
            mPresenter.getScenicBangDanRanking(330200);
        }
    }
}
