...
public class OthersAlbumDetailsActivity extends BaseActivity<AlbumPresenter, AlbumModel> implements AlbumContract.View {
    ...
    /*    int albumNum = recommendFriendsList.size();
     ...
     /*   mRvAlbum.setHasFixedSize(true);
        ...
        albumOprateAdapter = new AlbumOprateAdapter(OthersAlbumDetailsActivity.this, new AlbumOprateAdapter.AlbumOprateListener() {
            @Override
    ...
    public void initData() {
        showProgressDialog(OthersAlbumDetailsActivity.this);
        ...
        switch (res.getCode()) {
            case Constants.SUCCESS_CODE:
                try {
                    ...
                    GlideUtil.loadImage(OthersAlbumDetailsActivity.this, avatarUrl, mImgAvatar);
                ...
                break;
            default:
                showToast(OthersAlbumDetailsActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_save:
               ...
               /* hiddenIME();
                ...
                break;
            case R.id.rlyt_back:
                OthersAlbumDetailsActivity.this.finish();
                break;
            case R.id.tv_move_my_album:
                ...
                if (selectAlbumEditList != null && selectAlbumEditList.size() > 0) {
                    ...
                    showToast(OthersAlbumDetailsActivity.this, "请选择要转移的专辑内容");
                }
                break;
    ...
    public void showMsg(String msg) {
        dismissProgressDialog();
        showToast(OthersAlbumDetailsActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void oprateDialog() {
        ...
        if (oprateDialog == null) {
            ...
            oprateDialog = new OprateDialog(OthersAlbumDetailsActivity.this).builder().setTitle("确认要删除吗?");
            ...
            oprateDialog.setPositiveButton(getResources().getString(R.string.str_confirm), getResources().getColor(R.color.color_text_black7), new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (selectAlbumEditList != null && selectAlbumEditList.size() > 0) {
                        ...
                        showToast(OthersAlbumDetailsActivity.this, "请选择要删除的帖子");
                    }
                }
            });
        }
