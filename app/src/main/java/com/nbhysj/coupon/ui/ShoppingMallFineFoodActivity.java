 ...
 * description：美食
 */
public class ShoppingMallFineFoodActivity extends BaseActivity<FineFoodPresenter, FineFoodModel> implements FineFoodContract.View {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ShoppingMallFineFoodActivity.this);
        linearLayoutManager.setOrientation(linearLayoutManager.HORIZONTAL);
        mRvPopularScenicSpots.setLayoutManager(linearLayoutManager);
        deliciousFoodSectionAdapter = new DeliciousFoodSectionAdapter(ShoppingMallFineFoodActivity.this);
        deliciousFoodSectionAdapter.setDeliciousFoodRecommendList(mScenicSpotHotList);
        mRvPopularScenicSpots.setAdapter(deliciousFoodSectionAdapter);
        ...
        fineFoodListAdapter = new FineFoodListAdapter(ShoppingMallFineFoodActivity.this);
        fineFoodListAdapter.setFineFoodList(mScenicSpotList);
        mRvHotScenicSpot.setAdapter(fineFoodListAdapter);
    ...
    public void initData() {
        mRlytBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ShoppingMallFineFoodActivity.this.finish();
            }
        });
    ...
    public void showMsg(String msg) {
        dismissProgressDialog();
        showToast(ShoppingMallFineFoodActivity.this, Constants.getResultMsg(msg));
    ...
    public void getFineFoodHomePage() {
