 ...
 */
public class HomestayCateListActivity extends BaseActivity<HomestayPresenter, HomestayModel> implements HomestayContract.View {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        scenicSpotsLinearLayoutManager = new LinearLayoutManager(HomestayCateListActivity.this);
        ...
        homestayBangDanListAdapter = new HomestayBangDanListAdapter(HomestayCateListActivity.this);
        homestayBangDanListAdapter.setPopularScenicSpotsList(mHotelList);
        mRvMchCateList.setAdapter(homestayBangDanListAdapter);
    ...
    public void getHomestayListByCateIdResult(BackResult<MchCateListResponse> res) {
        ...
        switch (res.getCode()) {
            case Constants.SUCCESS_CODE:
                ...
                break;
            default:
                showToast(HomestayCateListActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
    ...
    {
        dismissProgressDialog();
        showToast(HomestayCateListActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void findHotelHomestayByCate() {
        if (validateInternet()) {
            ...
            mPresenter.getHomestayListByCateId(scenicSpotByCateRequest);
        }
    }
}
