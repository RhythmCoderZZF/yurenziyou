 ...
 * description：景点类目列表
 */
public class ScenicSpotCateListActivity extends BaseActivity<ScenicSpotPresenter, ScenicSpotModel> implements ScenicSpotContract.View {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        scenicSpotsLinearLayoutManager = new LinearLayoutManager(ScenicSpotCateListActivity.this);
        ...
        scenicSpotCateListAdapter = new ScenicSpotCateListAdapter(ScenicSpotCateListActivity.this);
        scenicSpotCateListAdapter.setPopularScenicSpotsList(mScenicSpotList);
        mRvScenicSpotBangdan.setAdapter(scenicSpotCateListAdapter);
    ...
    public void findScenicListByCateIdResult(BackResult<MchCateListResponse> res) {
        ...
        switch (res.getCode()) {
            case Constants.SUCCESS_CODE:
                ...
                break;
            default:
                showToast(ScenicSpotCateListActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
    ...
    public void showMsg(String msg) {
        ...
        dismissProgressDialog();
        showToast(ScenicSpotCateListActivity.this,Constants.getResultMsg(msg));
    }
