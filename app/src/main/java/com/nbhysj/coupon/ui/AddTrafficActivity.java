 ...
 * description：添加交通
 */
public class AddTrafficActivity extends BaseActivity {
    ...
    public void initView(Bundle savedInstanceState) {
        ToolbarHelper.setHeadBar(AddTrafficActivity.this, getResources().getString(R.string.str_add_traffic), R.mipmap.icon_left_arrow_black, "");
