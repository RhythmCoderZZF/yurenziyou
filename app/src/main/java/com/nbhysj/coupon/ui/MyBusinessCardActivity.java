...
public class MyBusinessCardActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MyBusinessCardActivity.this);
        linearLayoutManager.setOrientation(linearLayoutManager.HORIZONTAL);
        mRvBussinessCard.setLayoutManager(linearLayoutManager);
        MyBusinessCardOprateAdapter destinationScenicSpotsAdapter = new MyBusinessCardOprateAdapter(MyBusinessCardActivity.this);
