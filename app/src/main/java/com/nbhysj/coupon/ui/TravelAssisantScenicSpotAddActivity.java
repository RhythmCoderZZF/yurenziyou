 ...
 * description：添加景点
 */
public class TravelAssisantScenicSpotAddActivity extends BaseActivity<TravelAssistantPresenter, TravelAssistantModel> implements TravelAssistantContract.View, TravelAssisantAddScenicSpotFragment.AddScenicSpotListener {
                    ...
                    if (countyList != null) {
                        if (countyList.size() > 0) {
                            for (int i = 0; i < countyList.size(); i++) {
                                ...
                                fragments.add(new TravelAssisantAddScenicSpotFragment().newInstance(mTripId, countyId, mDayIndex));
                            }
                            travelAssistantCountryPagerAdapter.setTravelAssistantCountryList(fragments, countyList);
    ...
    public void showMsg(String msg) {
        ...
        dismissProgressDialog();
        showToast(TravelAssisantScenicSpotAddActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rlyt_back:
                ...
                TravelAssisantScenicSpotAddActivity.this.finish();
