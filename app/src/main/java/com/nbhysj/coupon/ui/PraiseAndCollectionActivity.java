 ...
 * description：赞与收藏
 */
public class PraiseAndCollectionActivity extends BaseActivity {
    //收到的评论
    @BindView(R.id.rv_praise_and_collection)
    ...
    public void initView(Bundle savedInstanceState) {
        ToolbarHelper.setBar(PraiseAndCollectionActivity.this, getResources().getString(R.string.str_praise_and_collection), R.mipmap.nav_ico_back_black);
