...
public class OthersCollectionDetailsActivity extends BaseActivity<MinePresenter, MineModel> implements MineContract.View {
    ...
    /*    int albumNum = recommendFriendsList.size();
     ...
     /*   mRvAlbum.setHasFixedSize(true);
        ...
        collectionOprateAdapter = new CollectionOprateAdapter(OthersCollectionDetailsActivity.this,type, new CollectionOprateAdapter.AlbumOprateListener() {
            @Override
    ...
    public void initData() {
        showProgressDialog(OthersCollectionDetailsActivity.this);
    ...
    public void getMineCollectionDetailResult(BackResult<MineCollectionDetailResponse> res) {
        ...
        switch (res.getCode()) {
            ...
            case Constants.USER_NOT_LOGIN_CODE:
                ...
                break;
            default:
                showToast(OthersCollectionDetailsActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
    ...
    public void onclick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_save:
                ...
                break;
            case R.id.rlyt_back:
                OthersCollectionDetailsActivity.this.finish();
                break;
    ...
    public void showMsg(String msg) {
        dismissProgressDialog();
        showToast(OthersCollectionDetailsActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void oprateDialog() {
        ...
        if (oprateDialog == null) {
            ...
            oprateDialog = new OprateDialog(OthersCollectionDetailsActivity.this).builder().setTitle("确认要删除吗?");
            ...
            oprateDialog.setPositiveButton(getResources().getString(R.string.str_confirm), getResources().getColor(R.color.color_text_black7), new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (selectAlbumEditList != null && selectAlbumEditList.size() > 0) {
                        ...
                        showToast(OthersCollectionDetailsActivity.this, "请选择要删除的收藏内容");
                    }
                }
            });
        }
