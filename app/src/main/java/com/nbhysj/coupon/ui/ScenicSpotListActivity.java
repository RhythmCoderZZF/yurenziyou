...
public class ScenicSpotListActivity extends BaseActivity {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        scenicSpotsLinearLayoutManager = new LinearLayoutManager(ScenicSpotListActivity.this);
        ...
        fineFoodListAdapter = new FineFoodListAdapter(ScenicSpotListActivity.this);
