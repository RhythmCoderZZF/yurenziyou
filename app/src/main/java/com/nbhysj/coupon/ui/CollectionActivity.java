 ...
 * description：收藏
 */
public class CollectionActivity extends BaseActivity<MinePresenter, MineModel> implements MineContract.View {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        zanAdapter = new ZanAdapter(CollectionActivity.this);
    ...
    public void initData() {
        ...
        showProgressDialog(CollectionActivity.this);
        getCollectionList();
    ...
    public void getCollectionMsgListResult(BackResult<ZanAndCollectionResponse> res) {
        ...
        switch (res.getCode()) {
            ...
            case Constants.USER_NOT_LOGIN_CODE:
                ...
                break;
            default:
                showToast(CollectionActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
    ...
    public void showMsg(String msg) {
        ...
        dismissProgressDialog();
        showToast(CollectionActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void getCollectionList() {
        ...
        if (validateInternet()) {
            mPresenter.getCollectionMsgList(mPageNo, mPageSize);
        }
    }
}
