...
public class StrategyCommentListActivity extends BaseActivity<StrategyPresenter, StrategyModel> implements StrategyContract.View,View.OnClickListener {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        ToolbarHelper.setBar(StrategyCommentListActivity.this, getResources().getString(R.string.str_comments_list), R.mipmap.nav_ico_back_black, "");

        articleId = getIntent().getIntExtra("articleId",0);

        if (strategyCommentList == null)
        {
            strategyCommentList = new ArrayList<>();

        } else {
            strategyCommentList.clear();
        }

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(StrategyCommentListActivity.this);
        mRvCommentList.setLayoutManager(linearLayoutManager);
        strategyCommentItemAdapter = new StrategyCommentItemAdapter(StrategyCommentListActivity.this);
        strategyCommentItemAdapter.setStrategyCommentList(strategyCommentList);
        mRvCommentList.setAdapter(strategyCommentItemAdapter);
    ...
    public void initData() {
        ...
        showProgressDialog(StrategyCommentListActivity.this);
            ...
            public void onRefresh(final RefreshLayout refreshLayout) {
                refreshLayout.getLayout().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mPageNo = 1;
                        strategyCommentList.clear();
                        strategyCommentItemAdapter.notifyDataSetChanged();
                        showProgressDialog(StrategyCommentListActivity.this);
                        getAllStrategyCommentListByArticleId();
            ...
            public void onLoadMore(final RefreshLayout refreshLayout) {
                refreshLayout.getLayout().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        isOnLoadMore = true;
                        try {
                            if (mTotalPageCount == strategyCommentList.size()) {
...
*/
    ...
    public void addStrategyCommentResult(BackResult res) {
        ...
        switch (res.getCode()) {
            ...
            case Constants.USER_NOT_LOGIN_CODE:
                ...
                break;
            default:
                showToast(StrategyCommentListActivity.this, Constants.getResultMsg(res.getMsg()));
                break;
        }
    }
        ...
        switch (res.getCode()) {
            case Constants.SUCCESS_CODE:
                try {
                    ...
                    List<StrategyCommentBean> postsCommentEntityList = res.getData().getResult();
                    ...
                    {
                        strategyCommentList.addAll(postsCommentEntityList);
                    }
    ...
    public void showMsg(String msg) {
        ...
        dismissProgressDialog();
        showToast(StrategyCommentListActivity.this, Constants.getResultMsg(msg));
    }
    ...
    public void getAllStrategyCommentListByArticleId(){
        ...
        if(validateInternet()){
            ...
            showProgressDialog(StrategyCommentListActivity.this);
            mPresenter.getStrategyCommentList(articleId,mPageNo,mPageSize);
        }
    ...
    public void strategyCommentRequest() {
        ...
        if (validateInternet()) {
            ...
            if (TextUtils.isEmpty(postCommentContent)) {
                dismissProgressDialog();
                showToast(StrategyCommentListActivity.this, "请填写评论");
                return;
            }
            StrategyCommentRequest strategyCommentRequest = new StrategyCommentRequest();
            strategyCommentRequest.setArticleId(articleId);
            strategyCommentRequest.setContent(postCommentContent);
            mPresenter.addStrategyCommentRequest(strategyCommentRequest);
