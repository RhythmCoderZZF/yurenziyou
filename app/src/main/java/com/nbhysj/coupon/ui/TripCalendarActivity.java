...
public class TripCalendarActivity extends BaseActivity {
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        ToolbarHelper.setBar(TripCalendarActivity.this, getResources().getString(R.string.str_calendar_select), R.mipmap.icon_left_arrow_black);
        ...
        switch (v.getId()) {
            case R.id.tv_next:
                ...
                if (!TextUtils.isEmpty(mStartDate) && !TextUtils.isEmpty(mEndDate)) {
                    ...
                    if (selectType == 0) {
                        intent.setClass(TripCalendarActivity.this, TravelAssistanSelectCountyActivity.class);
                    ...
                    showToast(TripCalendarActivity.this, "请选择时间区间");
                }
