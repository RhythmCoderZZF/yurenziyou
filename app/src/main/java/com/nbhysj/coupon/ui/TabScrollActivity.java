...
import com.nbhysj.coupon.view.CustomScrollView;
...
public class TabScrollActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollView = findViewById(R.id.scrollview_homestay_detail);
        imgAvatar = findViewById(R.id.image_avatar);

        mLlytHeader = findViewById(R.id.llyt_header);
        ...
        imgAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scrollView.smoothScrollBy(0, mLlytHeader.getHeight() - getStatusBarHeight(TabScrollActivity.this) - getStatusBarHeight(TabScrollActivity.this));
            }
        });
     ...
     /*   for (int i = 0; i < tabTxt.length; i++) {
        ...
        listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                View lastView = anchorList.get(anchorList.size() - 1);
